...
class EasyOptInsPostTypes {
		...
		foreach ( $layout_paths as $layout_path ) {
			...
			if ( $layout_helper->layout_enabled() ) {
				...
				switch ( FCA_EOI_EDITION ) {
					...
					case 'mailchimp':
						$upgrade_link = 'https://fatcatapps.com/optincat/upgrade/m?utm_campaign=sidebar%2Bad&utm_source=Optin%2BCat%2BFree%2BMailChimp&utm_medium=plugin';
						break;
					...
					default: 
						$upgrade_link = 'https://fatcatapps.com/optincat/upgrade/p?utm_campaign=sidebar%2Bad&utm_source=Optin%2BCat%2BFree&utm_medium=plugin';
	...
	public function ajax_subscribe() {
		...
		if ( empty( $list_id ) && $provider !== 'zapier' ) {
			echo "✗ List not set";
			exit;
		}
